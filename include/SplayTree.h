...
#include "C:\\Users\\Novozhilova Nastya\\BinaryTree\\include\\BinaryTree.h"
#include <iostream>
#include <cstdio>
#include <cstdlib>
using namespace std;
...
public:
	...
	Node<T>* SplayTree<T>::RR_Rotate(splay* k2);

	// LL(Y rotates to the left)
	Node<T>* SplayTree<T>::LL_Rotate(splay* k2);
...
template<class T>
inline Node<T>* SplayTree<T>::RR_Rotate(splay * k2)
{
	return NULL;
}
